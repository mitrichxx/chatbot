...
public class TestStuxnetMessage extends TestMessage{
    public static final String ANSWER_1 = "Промышленный вирус";
    public static final String ANSWER_2 = "Троянская программа";
    public static final String ANSWER_3 = "Макровирус";
