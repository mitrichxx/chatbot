...
public class FailFiledMessage extends Message {
    public FailFiledMessage(User user, Chat chat, String[] arguments) {
    ...
    public SendMessage execute() {
        return new SendMessage()
                ...
                .setText("*Это была проверка кибербезопастности, которую вы не прошли.*\n" +
                        "*Вы заполнили данные своей банковской карты на фишинговом сайте.*\n" +
